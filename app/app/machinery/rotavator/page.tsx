...
export default function RotavatorPage() {
  ...
  const fetchOverview = async () => {
    ...
    const [{ data: blades }, { data: expenses }] = await Promise.all([
      supabase.from("rotavator_blades").select("replacement_date, cost").order("replacement_date", { ascending: false }),
      ...
      <main className="flex-1 overflow-y-auto p-4">
        <div className="max-w-5xl mx-auto flex flex-col gap-3">
          ...
          <div className="flex items-center justify-between flex-wrap gap-2">
            <h1 className="text-xl font-bold text-primary">⚙️ {L("Rotavator", "ரோட்டவேட்டர்")}</h1>
            <button
          ...
          {activeTab === "blades" && (
            <MachineryRecordSection
              ...
              fields={[
                ...
                { key: "blade_brand", en: "Blade Brand", ta: "பிளேடு பிராண்ட்", type: "text" },
